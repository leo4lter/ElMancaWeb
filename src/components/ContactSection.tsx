...
export const ContactSection: React.FC = () => {
  ...
  return (
    <section
      id="contacto"
      className="relative w-full bg-[#050914] text-white px-5 sm:px-8 md:px-12 py-24 sm:py-32 select-none border-t border-[#2A52BE]/30 overflow-hidden"
        ...
        <div className="text-center max-w-3xl mx-auto mb-16 sm:mb-20">
          <FadeIn delay={0} y={20}>
            <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#111F4A] border border-[#2A52BE]/40 text-xs tracking-widest uppercase text-[#93C5FD] mb-4 font-semibold shadow-[0_0_20px_rgba(42,82,190,0.3)]">
              ...
              <span>{siteTexts.contactBadge || '#CONECTANDO PERSONAS • ESTAMOS A TU DISPOSICIÓN'}</span>
            </div>
