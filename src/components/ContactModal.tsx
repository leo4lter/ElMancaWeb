...
export const ContactModal: React.FC<ContactModalProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center px-4 bg-black/85 backdrop-blur-md transition-opacity">
      <div
      ...
      >
        ...
        {submitted ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <h3 className="text-2xl sm:text-3xl font-bold uppercase tracking-wide text-white mb-2">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                ...
                <div className="flex flex-col gap-1.5">
                  <label className="text-xs uppercase tracking-wider text-[#93C5FD] font-medium">
                    Nombre / Empresa
                  </label>
                  <input
                    type="text"
              ...
              <div className="flex flex-col gap-1.5">
                ...
                >
                  ...
                  <option value="Diseño Web Llave en Mano">
                    Diseño Web Llave en Mano (Hosting + Dominio + Webmail + 1 año mant.)
                  </option>
