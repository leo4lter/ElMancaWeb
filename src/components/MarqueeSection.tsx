        ...
        >
          {row1Tripled.map((item, index) => (
            <div
              ...
              className="group relative w-[360px] sm:w-[420px] h-[240px] sm:h-[270px] shrink-0 rounded-2xl overflow-hidden bg-[#0A1226] border border-[#2A52BE]/20 shadow-[0_10px_30px_rgba(0,0,0,0.7)] transition-all duration-300 hover:border-[#2A52BE]"
            >
              <img
                src={item.image}
                alt={item.title}
